...
const lodash = require('lodash')
    ...
    router.get('/test-me', function (req, res) {
        let names = [ 'swetha', 'shailja', 'soni', 'somya']
        ...
        let m1 = ['horror', 'darr']
        let m2 = ['drama','harrypotter']
        let m3 = ['thriller','tiger']
        let m4 = ['fantasy','frozen']
        let mObject = lodash.fromPairs([m1, m2, m3, m4])
        console.log('Movies object: ', mObject)
