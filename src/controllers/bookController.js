...
// const anyData = async function(req, res){
//     let data = req.query;
//     console.log(data)
//     let booklist= await BookModel.find({data:{$in:[{bookName},{authorName},{year},{prices},{stokAvailable},{totalPages}]}}).select({bookName:1, _id:0})
//     res.send({msg: booklist})
